...
const onMenuShow = () => {
  menuOpen.value = true;
  show.value = true; // Keep icon shown while menu is open
};
...
const onMenuHide = () => {
  ...
  if (!hovering.value) {
    show.value = false; // Hide icon when neither hovering nor menu open
  }
};
...
const onMenuItemClick = () => {
  menuOpen.value = false;
  show.value = false; // Hide the hover icon when an item is clicked
};
